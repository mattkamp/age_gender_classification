...
train_path = '/home/user/Desktop/Python/dataAge/'
...
n_input = 100 * 100 * 3 # MNIST data input (img shape: 100*100)
n_classes = 5 # MNIST total classes (0:male 1:female)
...
fig = plt.figure()
fig.suptitle('Gender classification MLP- Average accuracy test/train', fontsize=14, fontweight='bold')
...
fig.savefig('/home/user/Desktop/Python/gender_128x128.png')

fig = plt.figure()
fig.suptitle('Gender classification MLP- Average cost', fontsize=14, fontweight='bold')
plt.plot(axis_x, gr_cost, '--bo')
plt.legend()
ax = fig.add_subplot(111)
ax.set_ylabel('Cost')
ax.set_xlabel('Taining Epochs ')
fig.savefig('/home/user/Desktop/Python/gender_cost_128x128.png')
